    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_price', models.DecimalField(decimal_places=2, default=0, max_digits=200, verbose_name='Входная цена')),
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=200, verbose_name='Розничная цена')),
                ('price_ua', models.DecimalField(decimal_places=2, default=0, max_digits=200, verbose_name='Розничная цена UA')),
                ('price_old', models.DecimalField(decimal_places=2, default=0, max_digits=200, verbose_name='Старая розничная цена')),
                ('price_old_ua', models.DecimalField(decimal_places=2, default=0, max_digits=200, verbose_name='Старая розничная цена UA')),
                ...
                ('calculate_price', models.BooleanField(default=True, verbose_name='Пересчитать цену')),
