...
class TitleText(models.Model):
    name =  models.CharField(blank=False, max_length=100, verbose_name=_("Название"))
    text =  models.TextField(blank=False, verbose_name=_("Текст"))
    slug =  models.CharField(blank=True,  max_length=250, null=True, verbose_name=_("Иденитификатор"))
